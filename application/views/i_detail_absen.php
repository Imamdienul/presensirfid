                    ...
                    <ul>
                        ...
                        <li class="has_sub">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="<?= base_url() ?>kelas"><i class="ti-home"></i><span>Kelas</span></a></li>
                                <li><a href="<?= base_url() ?>walikelas/list_walikelas"><i class="mdi mdi-account-box"></i><span>Wali Kelas</span></a></li>
                                <li><a href="<?= base_url() ?>siswa"><i class="mdi mdi-account"></i><span>Siswa</span></a></li>
                                <li><a href="<?= base_url() ?>card/cetak_kartu"><i class="mdi mdi-account-card-details"></i><span>Cetak Kartu</span></a></li>
                                <li><a href="<?= base_url() ?>siswa/siswanew"><i class="mdi mdi-access-point"></i><span>RFID</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="has_sub">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="<?= base_url() ?>absensi"><i class="mdi mdi-account-check"></i><span>Riwayat Kehadiran</span></a></li>
                                <li><a href="<?= base_url() ?>alfa"><i class="mdi mdi-account-remove"></i><span>Alpa</span></a></li>
                                <li><a href="<?= base_url() ?>izin"><i class="mdi mdi-hospital"></i><span>Perizinan</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="has_sub">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="<?= base_url() ?>users"><i class="mdi mdi-account-key"></i><span>Admin</span></a></li>
                                <li><a href="<?= base_url() ?>devices"><i class="mdi mdi-xaml"></i><span>Device</span></a></li>
                                <li><a href="<?= base_url() ?>setting"><i class="mdi mdi-camera-timer"></i><span>Waktu Operasional</span></a></li>
                                <li><a href="<?= base_url() ?>kelas/manage_holidays"><i class="mdi mdi-calendar-remove"></i><span>Waktu Libur</span></a></li>
                                <li><a href="<?= base_url() ?>sql"><i class="mdi mdi-linux"></i><span>SQL Command</span></a></li>
                                <li><a href="<?= base_url() ?>settings"><i class="mdi mdi-application"></i><span>APP Settings</span></a></li>
                                <li><a href="<?= base_url() ?>ota"><i class="mdi mdi-airplane"></i><span>Over The Air</span></a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                                ...
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <h4 class="mt-0 header-title">
                                            Rekapitulasi Presensi Kelas : <?php echo $kelas->kelas; ?>
                                        </h4>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="date" name="tanggalMulai" 
                                                               value="<?php echo isset($_GET['tanggalMulai']) ? $_GET['tanggalMulai'] : ''; ?>" 
                                                               class="form-control" required>
                                                    </div>
                                                    <label for="tanggalSelesai" class="col-sm-2 col-form-label">Tanggal Selesai</label>
                                                    <div class="col-sm-4">
                                                        <input type="date" name="tanggalSelesai" 
                                                               value="<?php echo isset($_GET['tanggalSelesai']) ? $_GET['tanggalSelesai'] : ''; ?>" 
                                                               class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xl-12">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <h4 class="mt-0 header-title">
                                            Rekapitulasi Absensi Kelas : <?php echo $kelas->kelas; ?>
                                        </h4>
                                        <div class="table-responsive">
                                            <table id="datatable-buttons" class="table table-striped table-bordered w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php else: ?>
                                                        <tr>
                                                            <td colspan="<?php echo isset($rekap_absen) ? (count($rekap_absen) + 3) : 0; ?>">
                                                                Tidak ada data kehadiran dalam rentang tanggal yang diminta.
                                                            </td>
                                                        </tr>
                                                    <?php endif; ?>
                                                </tbody>
